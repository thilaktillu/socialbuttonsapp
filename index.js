export default function Component() {
  return (
    <div
      id="DesktopRoot"
      className="bg-black w-full min-h-screen flex flex-col items-center justify-center text-white p-4"
    >
      <div className="mb-10">
        <button className="bg-gray-800 px-6 py-2 rounded-md text-md mb-2">
          Anonymous
        </button>
